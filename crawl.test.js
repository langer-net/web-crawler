...
describe('crawl module', () => {
    ...
    test('getURLsFromHTML: absolute', () => {
        ...
        const inputBody = '<html lang="en"><body><a href="https://blog.boot.dev"><span>Boot.dev></span></a></body></html>';
    ...
    test('getURLsFromHTML: relative', () => {
        const inputURL = 'https://blog.boot.dev';
        const inputBody = '<html lang="en"><body><a href="/path/one"><span>Boot.dev></span></a></body></html>';
        const actual = getURLsFromHTML(inputBody, inputURL);
    ...
    test('getURLsFromHTML: both', () => {
        const inputURL = 'https://blog.boot.dev';
        const inputBody = '<html lang="en"><body><a href="/path/one"><span>Boot.dev></span></a><a href="https://other.com/path/one"><span>Boot.dev></span></a></body></html>';
        const actual = getURLsFromHTML(inputBody, inputURL);
